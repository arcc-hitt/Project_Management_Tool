...
class TimeEntry {
  ...
  static async findByUser(userId, filters: any = {}) {
    return TimeEntry.findAll({ userId, ...filters });
  }

  static async findByTask(taskId, filters: any = {}) {
    return TimeEntry.findAll({ taskId, ...filters });
  }

  static async findByProject(projectId, filters: any = {}) {
  ...
  static async getTotalHours(filters: any = {}) {
    const rows = await TimeEntry.findAll(filters);
    return {
  ...
  static async getTimeReport(filters: any = {}) {
    const rows = await TimeEntry.findAll(filters);
